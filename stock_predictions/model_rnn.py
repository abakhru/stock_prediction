...
class LstmRNN:
    ...
    def build_graph(self):
        ...
        LOGGER.info("inputs.shape:", self.inputs.shape)
    ...
    def train(self, dataset_list, config):
        ...
        LOGGER.info("len(merged_test_X) =", len(merged_test_X))
        LOGGER.info("len(merged_test_y) =", len(merged_test_y))
        LOGGER.info("len(merged_test_labels) =", len(merged_test_labels))
        ...
        LOGGER.info("Start training for stocks:", [d.stock_sym for d in dataset_list])
    ...
    def load(self):
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            LOGGER.info(f" [*] Success to read {ckpt_name}")
            return True, counter
        else:
