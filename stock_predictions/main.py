...
def main(stock, epochs, v1, v2, reset):
    ...
    if v2:
        p = StockPredictionV2(stock_symbol=stock,
                              start_date='2012-01-01', reset=reset)
        # p.basic_model(epochs=epochs, number_of_days=600)
        # p.model_with_sma_only(epochs=epochs, number_of_days=600)
        p.model_with_sma_mcad(epochs=epochs, number_of_days=60)
